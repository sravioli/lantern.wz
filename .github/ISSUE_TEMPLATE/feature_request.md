...
Describe how you'd expect this feature to work. Include API sketches, usage
examples, or configuration changes where applicable.
...
Describe any alternative solutions or workarounds you've considered and why they
fall short.

## Additional context (optional)

Any other details that might help: links to related issues, references to how
other WezTerm plugins handle this, screenshots, diagrams, etc.
