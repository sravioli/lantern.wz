...
---@module "lantern.flames.colorschemes.catppuccin-macchiato"

---@class Lantern.Flame
local M = {}

local color = require "lantern.color"
...
function M.ignite(Config, callback_opts)
  color.apply_scheme(Config, M.scheme, callback_opts.choice.id)
end
